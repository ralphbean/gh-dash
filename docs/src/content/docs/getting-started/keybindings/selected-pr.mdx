...
While triaging, the full help footer (press <kbd>?</kbd>) shows only the triage keybindings above
instead of the normal PR action list, since those actions have no effect until you exit triage.
